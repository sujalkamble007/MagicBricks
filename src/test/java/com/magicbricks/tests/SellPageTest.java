...
/**
 * Production-grade TestNG Test Class for MagicBricks Sell Module.
 * Aligned with Case Study 1 specifications:
 * - Exactly 8 Test Cases (7 Positive + 1 Negative)
 * - 3 Major Page Navigations originating strictly from header Sell dropdown:
 *   1. Rates & Trends (propertyRates.html)
 *   2. Find an Agent (Real-estate-property-top-agents)
 *   3. Developer Lounge (property.magicbricks.com/brand-store/)
 * - Full element highlighting (3px solid red border + yellow background)
 * - Smooth scrolling and visual pacing for tester observation and debugging.
 */
public class SellPageTest extends BaseTest {
     ...
     *
     * Exact Flow:
     * 1. Go to Contact page via Sell dropdown -> Sales Enquiry
     * 2. Smoothly scroll down the page to directory
     * 3. Highlight and select/click an element (e.g. city branch / alphabet filter)
     * 4. Smoothly scroll back up to the top of the page
     * 5. Highlight top header and switch back to original window
     */
    ...
    public void verifySalesEnquiryEmptySubmissionValidation() {
        ...
        // 1. Smoothly scroll down the page to the office contacts directory
        contactUsPage.scrollDownToDirectory();

        // 2. Select and highlight an element in the directory (e.g. alphabet link / city branch)
        ...
        // 3. Smoothly scroll back up to the top and highlight header
